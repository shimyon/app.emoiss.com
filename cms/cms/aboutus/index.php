...
<div class="listingTableDiv">
     <form method="post" name="aboutus" class="form-horizontal" id="aboutus"><div class="HundredPercentClass MarginTopBox border-bottom">
<div class="col-lg-2 col-sm-6">
  <h5><strong class="BlackColor">Add Content</strong></h5>
</div>
<div class="col-lg-7 col-sm-6"><textarea name="aboutus" class="jqte-test" placeholder="Aboutus&#x20;Page&#x20;Info">&lt;p&gt;&lt;span style=&quot;font-family: georgia, palatino;&quot;&gt;I Square Taxi, a prominent call taxi service in the city of Vellore. We are an online cab booking service providers, enabling customers with reliable and premium intercity and local car rental services. I Square taxi, a one way taxi and car booking online taxi service offers a diverse range of vehicles serving 24X7 with safety, promptness and comfort as the primary point of operations will delight you. I Square Call Taxi serves Vellore, Pondicherry, Salem, Coorg, Chennai, Hosur, Bangalore, Coimbatore, Neyveli, Kumbakonam, Trichy and several other cities with affordable cab booking service.&lt;/span&gt;&lt;/p&gt;
...
&lt;p&gt;&lt;span style=&quot;font-family: georgia, palatino;&quot;&gt;Dear travelers, we cater our service with a sense of safety, reliability and assurance. So, with all these benefits on your way, you can stop at us to reach your way on time in a simple way.&lt;/span&gt;&lt;/p&gt;</textarea> </div>
</div>
...
<div class="col-lg-6 col-sm-3"> 
               ...
               <input type="text" name="metatitle" class="form-control&#x20;seo" value="Call&#x20;Taxi&#x20;Booking&#x20;for&#x20;oneway&#x20;drop&#x20;&amp;&#x20;outstation" placeholder="metatitle"></div>
</div>
<div class="HundredPercentClass MarginTopBox para">
<div class="col-lg-2 col-sm-3">
...
<div class="col-lg-6 col-sm-3">
               <textarea name="metadescription" class="form-control&#x20;seo" placeholder="metadescription">I Square Taxi offers drop call taxi booking service from Vellore to Chennai, Bangalore, Hosur, Salem, Pondicherry, Coorg etc</textarea>    <!--<textarea class="form-control" rows="5" id="comment"></textarea>-->
</div>
</div>
<div class="HundredPercentClass MarginTopBox para">
<div class="col-lg-2 col-sm-3">
...
<div class="col-lg-6 col-sm-3">
    <textarea name="metakeywords" class="form-control&#x20;seo" placeholder="metakeywords">call taxi in vellore, cab service in vellore, call Taxi vellore to chennai, vellore to chennai car booking, vellore call taxi number, taxi vellore,</textarea>    <!--<textarea class="form-control" rows="5" id="comment"></textarea>-->
</div>
</div>
<div class="HundredPercentClass MarginTopBox">
<div class="col-lg-2 col-sm-3">

    ...
    <div class="UserContainerDiv">  
        <div class="row">
                ...
                <div class="col-lg-3 col-sm-3">
                    <div style="width:100%; height:auto; float:left; padding:10px;">

                        <h5 class="text-center img-thumbnail img-responsive" style="width:100%; border-radius:0px; border-bottom:0px; border-color:#ABABAB;background-color:#fff;">Default</h5>

                        <p style="margin-bottom:0px;">

                            <img class="img-thumbnail img-responsive" style="margin-bottom:0px; border-bottom:0px; border-top:0px; border-radius:0px; width:100%;  border-color: #ababab" src="/images/templates/Default.png">
                        </p>

                        <div style="width:100%; height:auto; float:left; margin-top:0px; padding:5px 5px 0px 5px; border:1px solid #ABABAB; background-color:#f1f1f1; border-top:1px solid #ccc">
                            <div class="row">
                                <div class="col-xs-6">
                                    <a class="btn btn-default" data-lightbox="image-1" href="/images/templates/Default.png" style="font-size:90%;" target="_blank">Preview</a>
                                </div>
                                <div class="col-xs-6">
                                    <button class="btn btn-default pull-right"  onclick="setThis('0');" type="button" style="font-size:90%;">Apply</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-sm-3">
                    <div style="width:100%; height:auto; float:left; padding:10px;">
                        ...
                        <h5 class="text-center img-thumbnail img-responsive" style="width:100%; border-radius:0px; border-bottom:0px; border-color:#ABABAB;background-color:#fff;">Template_1</h5>

                        <p style="margin-bottom:0px;">

                            <img class="img-thumbnail img-responsive" style="margin-bottom:0px; border-bottom:0px; border-top:0px; border-radius:0px; width:100%;  border-color: #ababab" src="/images/templates/Template_1.png">
                        </p>

                        <div style="width:100%; height:auto; float:left; margin-top:0px; padding:5px 5px 0px 5px; border:1px solid #ABABAB; background-color:#f1f1f1; border-top:1px solid #ccc">
                            <div class="row">
                                <div class="col-xs-6">
                                    <a class="btn btn-default" data-lightbox="image-1" href="/images/templates/Template_1.png" style="font-size:90%;" target="_blank">Preview</a>
                                </div>
                                <div class="col-xs-6">
                                    <button class="btn btn-default pull-right"  onclick="setThis('1');" type="button" style="font-size:90%;">Apply</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-sm-3">
                    <div style="width:100%; height:auto; float:left; padding:10px;">
                        ...
                        <h5 class="text-center img-thumbnail img-responsive" style="width:100%; border-radius:0px; border-bottom:0px; border-color:#ABABAB;background-color:#fff;">Template_2</h5>

                        <p style="margin-bottom:0px;">

                            <img class="img-thumbnail img-responsive" style="margin-bottom:0px; border-bottom:0px; border-top:0px; border-radius:0px; width:100%;  border-color: #ababab" src="/images/templates/Template_2.png">
                        </p>

                        <div style="width:100%; height:auto; float:left; margin-top:0px; padding:5px 5px 0px 5px; border:1px solid #ABABAB; background-color:#f1f1f1; border-top:1px solid #ccc">
                            <div class="row">
                                <div class="col-xs-6">
                                    <a class="btn btn-default" data-lightbox="image-1" href="/images/templates/Template_2.png" style="font-size:90%;" target="_blank">Preview</a>
                                </div>
                                <div class="col-xs-6">
                                    <button class="btn btn-default pull-right"  onclick="setThis('2');" type="button" style="font-size:90%;">Apply</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-sm-3">
                    <div style="width:100%; height:auto; float:left; padding:10px;">
                        ...
                        <h5 class="text-center img-thumbnail img-responsive" style="width:100%; border-radius:0px; border-bottom:0px; border-color:#ABABAB;background-color:#fff;">Template_3</h5>

                        <p style="margin-bottom:0px;">

                            <img class="img-thumbnail img-responsive" style="margin-bottom:0px; border-bottom:0px; border-top:0px; border-radius:0px; width:100%;  border-color: #ababab" src="/images/templates/Template_3.png">
                        </p>

                        <div style="width:100%; height:auto; float:left; margin-top:0px; padding:5px 5px 0px 5px; border:1px solid #ABABAB; background-color:#f1f1f1; border-top:1px solid #ccc">
                            <div class="row">
                                <div class="col-xs-6">
                                    <a class="btn btn-default" data-lightbox="image-1" href="/images/templates/Template_3.png" style="font-size:90%;" target="_blank">Preview</a>
                                </div>
                                <div class="col-xs-6">
                                    <button class="btn btn-default pull-right"  onclick="setThis('3');" type="button" style="font-size:90%;">Apply</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-sm-3">
                    <div style="width:100%; height:auto; float:left; padding:10px;">
                        ...
                        <h5 class="text-center img-thumbnail img-responsive" style="width:100%; border-radius:0px; border-bottom:0px; border-color:#ABABAB;background-color:#fff;">Template_5</h5>

                        <p style="margin-bottom:0px;">

                            <img class="img-thumbnail img-responsive" style="margin-bottom:0px; border-bottom:0px; border-top:0px; border-radius:0px; width:100%;  border-color: #ababab" src="/images/templates/Template_5.png">
                        </p>

                        <div style="width:100%; height:auto; float:left; margin-top:0px; padding:5px 5px 0px 5px; border:1px solid #ABABAB; background-color:#f1f1f1; border-top:1px solid #ccc">
                            <div class="row">
                                <div class="col-xs-6">
                                    <a class="btn btn-default" data-lightbox="image-1" href="/images/templates/Template_5.png" style="font-size:90%;" target="_blank">Preview</a>
                                </div>
                                <div class="col-xs-6">
                                    <a class="btn btn-default  pull-right" href="/cms/cms/customtheme" style="font-size:90%;" >Customize</a>
                                    <!--<button class="btn btn-default"  onclick="setThis('5');" type="button" style="font-size:90%;">Apply</button>-->
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!--            <div class="col-lg-3 col-sm-3">
                            <div style="width:100%; height:auto; float:left; padding:10px;">
                                ...
                                <h5 class="text-center img-thumbnail img-responsive" style="width:100%; border-radius:0px; border-bottom:0px; border-color:#ABABAB;background-color:#fff;">Theme 1</h5>
            
                                <p style="margin-bottom:0px;">
            
                                    <img class="img-thumbnail img-responsive" style="margin-bottom:0px; border-bottom:0px; border-top:0px; border-radius:0px; border-color: #ababab" src="http://www.designyourway.net/diverse/5/lightbox/dimsemenov_com_plugins_magnific-popup.jpg">
                                </p>
                                ...
                                <div style="width:100%; height:auto; float:left; margin-top:0px; padding:5px 5px 0px 5px; border:1px solid #ABABAB; background-color:#f1f1f1; border-top:1px solid #ccc">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6">
                                            <a class="btn btn-default" data-lightbox="image-1" href="../images/Template_1.jpg" style="font-size:90%;">Preview</a>
                                        </div>
                                        <div class="col-xs-6">
                                            <button class="btn btn-default pull-right" type="button" style="font-size:90%;">Apply</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
                                    function setThis(id) {
                                        ajaxindicatorstart('');
                                        $.ajax({
                                            url: '/cms/cms/settemplates',
                                            type: 'POST',
                                            dataType: 'text',
                                            data: {id: id},
                                            success: function (data) {
                                                ajaxindicatorstop();
                                                if (($.trim(parseInt(data))) == 1) {
                                                    swal("success ", 'Theme Has been applied successfully!', 'success');
                                                } else {
                                                    swal("ERROR ", 'Theme Cant be Set!', 'error');
                                                }
                                            }
                                        });
                                    }

...
<!--<link rel="stylesheet" href="/ckeditor/css/samplesOld.css">-->
<link rel="stylesheet" href="/ckeditor/toolbarconfigurator/lib/codemirror/neo.css">

 
<form method="post" name="custompage" class="form-horizontal" id="custompage">
    <div class="row">
            <div class="col-lg-6"> 
...
<div class="CalenderOuter"></div>
  ...
  <div class="row MarginTopBox para">
            <div class="col-lg-2 col-sm-3">
                <h5><strong class="BlackColor"><label for="pagetitle">Page URL</label> </strong></h5>
                
            </div>
      
            <div class="col-lg-6 col-sm-3"> 

                <input type="text" name="pagetitle" class="form-control&#x20;seo" value="" placeholder="Page&#x20;URL"><div class='GreyColor' >(must in lowercase and separated by -. It will auto convert into Proper Page title,<br>ex: url = mumbai-to-goa ; link on Page = 'Mumbai To Goa' )</div>            </div>
        </div>
        
       
        <div class="row">
            <div class="col-lg-12">
                <p class="GreyColor">(SEO) We need to Optimize the meta title and meta description telling searchers about the page. </p>
            </div></div>
        <div class="row para">
            <div class="col-lg-2 col-sm-3">
            ...
            <div class="col-lg-6 col-sm-3"> 
                ...
                <input type="text" name="metatitle" class="form-control&#x20;seo" value="" placeholder="metatitle">            </div>
        </div>
        <div class="row para">
            <div class="col-lg-2 col-sm-3">
                <h5><strong class="BlackColor"> <label for="metadescription">Meta description</label> </strong></h5>
                
            </div>
            <div class="col-lg-6 col-sm-3">
                <textarea name="metadescription" class="form-control&#x20;seo" placeholder="metadescription"></textarea>                <!--<textarea class="form-control" rows="5" id="comment"></textarea>-->
            </div>
        </div>
        <div class="row  para">
            <div class="col-lg-2 col-sm-3">
                <h5><strong class="BlackColor"> <label for="metakeywords">Meta Keywords</label>                    </strong></h5>
            </div>
            <div class="col-lg-6 col-sm-3">
                <textarea name="metakeywords" class="form-control&#x20;seo" placeholder="metakeywords"></textarea>                <!--<textarea class="form-control" rows="5" id="comment"></textarea>-->
            </div>
        </div>
         <div class="row para" style="height: 52px;">
            <div class="col-lg-2 col-sm-3">
                <h5><strong class="BlackColor"><label for="metatitle">Page Content</label> </strong></h5>
                
            </div>
        </div>
        <div class="col-sm-12 para">
          <textarea name="page_content" class="jqte-test" id="editor" placeholder="Page&#x20;Content"></textarea>           
        </div>
  ...
  <div class="col-lg-6 col-sm-12">
                 <div class="panel panel-default">
                    <div class="panel-heading"  data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne" style="cursor: pointer;">Steps to upload image in custom page.</div>
                    <div class="panel-body panel-collapse collapse" id="collapseOne">
                     <ol>
                    <li> Store image in your google drive. </li>
                    <li> Share it as "Public on web". </li>
                    <li> Create a share link, and copy it. </li>
                    <li> Paste copied link to the "Google Image Path". </li>
                    <li> click on "Generate Link". </li>
                    <li> Copy generated link and paste in url of Image Control. </li>
                </ol>
                    </div>
                 </div>
                </div>
            ...
            <div class="col-lg-6 col-sm-12">
                ...
                <label>Google Image Path</label>
               
    <div class="input-group">
   <input type="text" id="googleimg" class="form-control googleimg" placeholder="google drive shared path" >
      <span class="input-group-btn">
          <button class="btn btn-default" type="button"  onclick="callme()">Generate Link!</button>
      </span>
    </div><!-- /input-group -->
 
      <div class="alert alert-danger hiddena" style="display: none;">URL is not valid</div>
                
                </div>
                <div class="form-group" >
                 <div class="panel panel-default">
                    <div class="panel-heading">Generated Image Link</div>
                    <div class="panel-body" id="generatedlink">....</div>
                 </div>
             
                </div>
            </div>
            <div class="col-lg-6 col-sm-12" style="padding:20px 0;">
...
<div class="clearfix"></div>
    <script>
        initSample();
        setTimeout(function(){ $('.flashmsg').slideUp(600); }, 3000);
        $('#googleimg').keyup(function(){
             $('.hiddena').slideUp(500);
        });
        function callme(){
            $('#generatedlink').text('...');
               $('.hiddena').hide();
            if($('#googleimg').val()!=""){
                var imgpath= $('#googleimg').val();
                var imgn= imgpath.split('/');
                var imgnid= imgpath.split('id='); 
                
                if(imgn[5]!=undefined){
                    $('#generatedlink').text("https://drive.google.com/uc?id="+imgn[5]);
                }else if(imgnid[1]!=undefined){
                    $('#generatedlink').text("https://drive.google.com/uc?id="+imgnid[1]);
                }
                else{
                    $('.hiddena').show();

...
</script><script src="/ckeditor/js/ckeditor.js"></script>
...
<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-6 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Customize Tooltip</h4>
        </div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
                            <div class="modal-dialog modal-md" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="exampleModalLabel">Customize ToolTip Content</h4>   
                                    </div>
                                     
                                    <div class="modal-body">
                                         <div class="row MarginTopBox commentclass" style="display:block;"> 
        <div class="col-sm-12">
        <textarea id="linkcomment" name="linkcomment" rows="15" cols="80"></textarea>   
        </div>
                                         </div>      
                                        
                                    </div>
                                    <div class="modal-footer">
                                        <input type="button" class="btn btn-primary" value="Customize" name="custbtn"  id="custbtn" /> 
                                    </div>
    ...
    <div class="row ">
        ...
        <div class="table-responsive">          
            <table id="pages" class="table table-hover" style="margin-bottom: 0;">
                      ...
                      <span id="tslId-1"  class="UserEditIcon"></span>   
                                </td>
                      ...
                      <span id="tslId-2"  class="UserEditIcon"></span>   
                                </td>
                      ...
                      <span id="tslId-3"  class="UserEditIcon"></span>   
                                </td>
                      ...
                      <span id="tslId-4"  class="UserEditIcon"></span>   
                                </td>
                      ...
                      <span id="tslId-5"  class="UserEditIcon"></span>   
                                </td>
                      ...
                      <span id="tslId-6"  class="UserEditIcon"></span>   
                                </td>
                      ...
                      <span id="tslId-7"  class="UserEditIcon"></span>   
                                </td>
                      ...
                      <span id="tslId-8"  class="UserEditIcon"></span>   
                                </td>
                      ...
                      <span id="tslId-10"  class="UserEditIcon"></span>   
                                </td>
                      ...
                      <span id="tslId-11"  class="UserEditIcon"></span>   
                                </td>
                      ...
                      <span id="tslId-12"  class="UserEditIcon"></span>   
                                </td>
                      ...
                      <span id="tslId-13"  class="UserEditIcon"></span>   
                                </td>
    ...
    $(document).on("click",".UserEditIcon",function(){
          CKEDITOR.instances.linkcomment.setData('');
        $("#exampleModal").modal('show'); 
       var Id= $(this).prop('id').split('-');     
      GlobalId=Id[1]; 
      $.ajax({
            type: "POST", 
                url: "/cms/cms/ajaxgetcustomizetooltip", // call to Action method in COntroller 
                data: {postId:GlobalId}, 
                dataType: "JSON",
                success: function (data) {
                    ajaxindicatorstop();   
                    ...
                    if(data['success']==0){  
                        ...
                        CKEDITOR.instances.linkcomment.insertHtml(""+data['content']+"");   
    ...
    $("#custbtn").click(function(){
        var datas = CKEDITOR.instances.linkcomment.getData();  
        if(datas.length!=0){
        $.ajax({
            type: "POST", 
                url: "/cms/cms/ajaxcustomizetooltip", // call to Action method in COntroller 
                data: {postId:GlobalId,postcontent:datas}, 
                dataType: "JSON",
                success: function (data) {
                    ajaxindicatorstop();   
                    ...
                    if(data==0){  
                        ...
                        swal('Done','Customized TollTip Contents','success');   
                        location.reload();
                 }  
                },
                failure: (function () {
         ...
         swal('error','Tooltip Contents Required','error');
    }
    });
</script>
<style>  
